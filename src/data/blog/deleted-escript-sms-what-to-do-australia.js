...
const post = {
  ...
  permanentFix: {
    ...
    openPharmacySteps: {
      ...
      steps: [
        ...
        {
          number: 3,
          name: "Enter or scan your eScript token",
          description:
            "Paste the token code from your SMS, or use the in-app scanner to scan the QR code directly from the message. OpenPharmacy retrieves your prescription details from the national system.",
        },
        {
          number: 4,
  ...
  faq: [
    ...
    },
    {
      ...
      answer:
        "The most reliable solution is to save each eScript token to a dedicated wallet app like OpenPharmacy as soon as you receive the SMS. The app stores your prescription QR codes with end-to-end encryption on your device, making them available at any time — even without internet access. Once saved to the app, you no longer need the original SMS.",
    },
    {
