...
const post = {
  ...
  privacySection: {
    ...
    body: [
      ...
      `For patients managing prescriptions related to mental health, sexual health, substance use, or other sensitive conditions, this trade-off may feel different. A person filling scripts for an antidepressant, an HIV prevention medication, or opioid dependency treatment has a reasonable interest in keeping that information within a tightly controlled circle.`,
