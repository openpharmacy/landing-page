...
const post = {
  ...
  comparisonTable: {
    headers: ["App", "Best For", "Works Offline?", "ADHA Conformant?", "Family Profiles?", "Data Stored in AU?", "Price"],
    rows: [
  ...
  apps: [
    {
      ...
      body: [
        ...
        `For caregivers and families, OpenPharmacy supports separate profiles for family members, allowing parents to manage children's scripts and adult children to manage prescriptions for elderly parents — all within one app.`,
    ...
    },
    {
      ...
      body: [
        `Scripty also works offline and stores data on Australian servers with end-to-end encryption. It supports family and carer profiles, allows you to organise scripts by person, and includes Medicine Shortage Alerts that notify you if one of your medications is affected by a national shortage.`,
      ...
      pros: [
        ...
        "Family and carer friendly — organises scripts by person",
        "Free and ad-free",
      ],
      consLabel: "Things to consider",
      cons: [
        "ASL setup requires a pharmacy visit and 100 points of ID if not previously registered",
        "No PIN or biometric lock by default — optional biometric lock only",
      ],
    },
    {
      name: "MedAdvisor",
    ...
    },
    {
      ...
      body: [
        ...
        `For users whose primary need is a dedicated eScript wallet — especially one that works offline without a myGov login — the my health app is more complex to set up than purpose-built options. It does not support offline QR code display in the same way as OpenPharmacy or Scripty, and does not include family profiles for managing other people's scripts.`,
  ...
  howToChoose: {
    ...
    questions: [
      ...
      },
      {
        ...
        answer: `If you are a carer managing prescriptions for children, elderly parents, or a partner, you need an app that supports separate profiles under one account. OpenPharmacy, Scripty, and MedAdvisor all support family profiles. OpenPharmacy and Scripty both allow you to store and present QR codes for any family member's scripts at any pharmacy. MedAdvisor ties this to a pharmacy network. The my health app does not support managing other people's scripts.`,
  ...
  faq: [
    ...
    },
    {
      ...
      answer: "OpenPharmacy and Scripty are both strong choices for carers. OpenPharmacy allows you to manage separate script profiles for family members — including children and parents — within one app, with all QR codes accessible offline. Scripty also supports family and carer profiles with ASL auto-sync. MedAdvisor supports family management but requires pharmacy network activation.",
    },
    {
