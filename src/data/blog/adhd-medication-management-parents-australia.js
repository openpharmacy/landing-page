...
const post = {
  ...
  regulatoryReality: {
    ...
    body: [
      ...
      `For children, diagnosis and the initiation of stimulant treatment is restricted to paediatricians and child and adolescent psychiatrists in most states and territories. Queensland and, from late 2025, certain states including NSW have introduced pathways for trained GPs to continue prescriptions for stable patients under shared-care or continuation-prescriber arrangements — but the initial prescription must still come from a specialist.`,
