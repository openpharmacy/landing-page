      ...
      <main className="mt-16 md:mt-20">
        ...
        <div className="prose prose-invert max-w-none">
          <p className="text-base md:text-lg font-extralight leading-relaxed text-white/80 mb-8">
            We at OpenPharmacy value your privacy and are committed to
            protecting your personal information. This Privacy Policy outlines
            how we collect, use, store, and disclose your personal information
            in accordance with the Privacy Act 1988 (Cth). By using the
            OpenPharmacy app, you consent to the practices described in this
            policy.
          </p>
          <p className="text-base md:text-lg font-extralight leading-relaxed text-white/80 mb-8">
          ...
          <section className="mb-8">
            ...
            <p className="text-base md:text-lg font-extralight leading-relaxed text-white/80 mb-4">
              We collect personal information when you use OpenPharmacy, and
              this may include:
            </p>
            <ul className="list-disc pl-6 mb-4">
              <li className="text-base md:text-lg font-extralight leading-relaxed text-white/80 mb-2">
                Identification details such as your name, date of birth,
              ...
              <li className="text-base md:text-lg font-extralight leading-relaxed text-white/80 mb-2">
                Device information, such as IP address, device ID, and usage
                data when accessing the app.
              </li>
              <li className="text-base md:text-lg font-extralight leading-relaxed text-white/80 mb-2">
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 mb-4">
              ...
              <li className="text-base md:text-lg font-extralight leading-relaxed text-white/80 mb-2">
                When you provide personal details through customer support,
                forms, or via third-party services.
              </li>
              <li className="text-base md:text-lg font-extralight leading-relaxed text-white/80 mb-2">
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 mb-4">
              ...
              <li className="text-base md:text-lg font-extralight leading-relaxed text-white/80 mb-2">
                To verify your identity when linking to MySL and other
                integrated services.
              </li>
              <li className="text-base md:text-lg font-extralight leading-relaxed text-white/80 mb-2">
              ...
              <li className="text-base md:text-lg font-extralight leading-relaxed text-white/80 mb-2">
                To conduct research and improve our services, including
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 mb-4">
              ...
              <li className="text-base md:text-lg font-extralight leading-relaxed text-white/80 mb-2">
                To third-party healthcare providers who help deliver services
                via the OpenPharmacy app.
              </li>
              <li className="text-base md:text-lg font-extralight leading-relaxed text-white/80 mb-2">
            ...
            <p className="text-base md:text-lg font-extralight leading-relaxed text-white/80">
              ...
              unless it is necessary to provide the services you have requested
          ...
          <section className="mb-8">
            ...
            <p className="text-base md:text-lg font-extralight leading-relaxed text-white/80">
              ...
              destruction. However, no system can guarantee complete security,
              so while we strive to protect your data, we cannot guarantee the
          ...
          <section className="mb-8">
            ...
            <p className="text-base md:text-lg font-extralight leading-relaxed text-white/80">
              ...
              we hold about you. If you would like to view or update your
          ...
          <section className="mb-8">
            ...
            <p className="text-base md:text-lg font-extralight leading-relaxed text-white/80">
              OpenPharmacy may contain links to third-party websites or
              services. These external sites have their own privacy policies,
          ...
          <section className="mb-8">
            ...
            <p className="text-base md:text-lg font-extralight leading-relaxed text-white/80">
              ...
              contact us. We take complaints seriously and will aim to resolve
              any issues in a timely and transparent manner. If you are
              unsatisfied with our response, you have the right to escalate your
          ...
          <section className="mb-8">
            ...
            <p className="text-base md:text-lg font-extralight leading-relaxed text-white/80">
              ...
              effective immediately upon publication on our website. Please
