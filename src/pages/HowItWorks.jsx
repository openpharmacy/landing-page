    ...
    <Layout>
      <main className="flex flex-col gap-8 md:gap-12">
          ...
          <div className="flex flex-col md:flex-row gap-8 w-full justify-center items-center">
            {easySteps.map((step, idx) => (
              <Motion.div
                ...
                viewport={{ once: true }}
                className="bg-[var(--color-secondary)] rounded-2xl p-6 flex-1 min-w-[220px] max-w-xs text-center shadow-lg flex flex-col items-center"
              >
        ...
        <div className="flex justify-center mb-8 md:mb-20 text-lg">
          <div className="bg-[var(--color-secondary)] rounded-full p-1 flex">
            <button
